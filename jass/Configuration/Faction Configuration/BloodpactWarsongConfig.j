...
library BloodpactWarsongConfig initializer OnInit requires Faction

    private function OnInit takes nothing returns nothing
        local Faction f
        
        set f = Faction.create(18,"Warsong (Bloodpact)", PLAYER_COLOR_ORANGE, "|c00ff8000","ReplaceableTextures\\CommandButtons\\BTNChaosGrom.blp")
            ...
            call f.registerObjectLimit('o01Q', UNLIMITED)   //Warsong Raider (Bloodpact)
            call f.registerObjectLimit('nckb', 2)           //Kodo Beast (Bloodpact)
            call f.registerObjectLimit('n087', UNLIMITED)   //Orc Warlock (Bloodpact)
            ...
            call f.registerObjectLimit('n09E', 6)           //Orc Champion (Bloodpact)
            call f.registerObjectLimit('n07M', UNLIMITED)   //Warsong Grunt (Bloodpact)
            ...
            call f.registerObjectLimit('o01N', -UNLIMITED+6)//Blademaster (Bloodpact)
