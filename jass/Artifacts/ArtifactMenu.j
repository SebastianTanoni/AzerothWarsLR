library ArtifactMenu initializer OnInit requires Artifact, Persons, Faction
    ...
    private function OnInit takes nothing returns nothing
        ...
        //Key events for controlling the menu
/*         loop
        exitwhen i > 24
            set trig = CreateTrigger()
            call BlzTriggerRegisterPlayerKeyEvent(trig, Player(i), OSKEY_RIGHT, 0, false)
            call TriggerAddCondition(trig, Condition(function ArtifactMenuPage.nextButtonClick))
            set i = i + 1
        endloop  
        ...
        exitwhen i > 24
            set trig = CreateTrigger()
            call BlzTriggerRegisterPlayerKeyEvent(trig, Player(i), OSKEY_LEFT, 0, false)
            call TriggerAddCondition(trig, Condition(function ArtifactMenuPage.prevButtonClick))
            set i = i + 1
        endloop   
        ...
        exitwhen i > 24
            set trig = CreateTrigger()
            call BlzTriggerRegisterPlayerKeyEvent(trig, Player(i), OSKEY_ESCAPE, 0, false)
            call TriggerAddCondition(trig, Condition(function ArtifactMenuPage.exitButtonClick))
            set i = i + 1
        endloop       */     
